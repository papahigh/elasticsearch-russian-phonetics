...
E.g., command for Elasticsearch 7.1.0

[source,sh,options="wrap"]
----
# install plugin on Elasticsearch 7.1.0
$ bin/elasticsearch-plugin install https://github.com/papahigh/elasticsearch-russian-phonetics/raw/7.1.0/esplugin/plugin-distributions/analysis-russian-phonetic-7.1.0.zip
----
