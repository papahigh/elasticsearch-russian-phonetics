...
$ bin/elasticsearch-plugin install https://github.com/papahigh/elasticsearch-russian-phonetics/raw/7.0.0/esplugin/plugin-distributions/analysis-russian-phonetic-7.0.0.zip
----
