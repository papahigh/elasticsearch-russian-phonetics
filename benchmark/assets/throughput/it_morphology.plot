...
set output 'it_morphology.png'

load 'it.pal'

set title "Encoding throughput by iteration, ops/sec (Russian morphology)" font ",14"
set tmargin 5
set bmargin 5
...
plot for [i=2:10] 'it_morphology.dat' using i:xticlabel(getXLabel($1)) ls (i-1) title columnheader(i)
