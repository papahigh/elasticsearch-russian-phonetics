...
set output 'avg_morphology.png'

load 'it.pal'
unset colorbox

set title "Average encoding throughput, ops/sec (Russian morphology)" font ",14"
set tmargin 5
set bmargin 7
...
plot './avg_morphology.dat' using ($0):2:($3):xtic(1) notitle with boxes palette;
